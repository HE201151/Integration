...
public class ConnEventParticip extends AsyncTask<String, Void, String> {
    ...
    public interface CustomInterface{
        ...
        void showResultat(String s);

    }

    public ConnEventParticip(CustomInterface callback){
